      ...
      <div className="flex flex-1 min-h-0 w-full overflow-hidden bg-white">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto p-6 space-y-6">
          <div className="w-full max-w-[620px] mx-auto space-y-5">
            ...
            {/* Stacked Action & Alert Cards */}
            <div className="space-y-2.5">
              {/* Action Card 1: Add a guide */}
              <div className="p-3.5 rounded-xl border border-slate-200 bg-white flex items-center justify-between hover:border-slate-300 transition-colors cursor-pointer shadow-2xs group">
                ...
                <ChevronRight className="w-4 h-4 text-slate-500 group-hover:text-slate-800 shrink-0 ml-2" />
              </div>

              {/* Action Card 2: Test runs credit notice */}
              <div className="p-3.5 rounded-xl border border-slate-200 bg-white flex items-center justify-between hover:border-slate-300 transition-colors cursor-pointer shadow-2xs group">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600 leading-snug mt-0.5">
                      ...
                      <span className="text-[#be4c3f] font-semibold hover:underline">
                        Learn more.
                      </span>
                    </p>
                  </div>
              ...
              {/* Action Card 3: Out of credits alert - Solid Fill */}
              <div className="p-3.5 rounded-xl bg-[#be4c3f] text-white flex items-center justify-between shadow-xs">
                <div className="flex items-center gap-3">
                ...
                <button
                  onClick={() => {
                    setCreditsRemaining(2500)
                    showToast("Added 2,500 test execution credits!")
                  }}
                  className="px-4 py-1.5 bg-white hover:bg-slate-100 text-[#be4c3f] text-xs font-bold rounded-lg shadow-xs transition-colors"
                >
                  {creditsRemaining === 0 ? "Upgrade" : "Refill"}
                </button>
              </div>
            </div>
